...
var (
	apiRule = v3.Rule{
		Ingress: []v3.IngressRule{
			{
				FromEndpoint: []v3.EndpointSelector{
					v3.NewESFromLabels(
		...
		Egress: []v3.EgressRule{
			{
				...
				ToCIDR: []v3.CIDR{"10.0.0.1"},
			}, {
				ToCIDRSet: []v3.CIDRRule{{Cidr: v3.CIDR("10.0.0.0/8"), ExceptCIDRs: []v3.CIDR{"10.96.0.0/12"}}},
			},
		},
	}
	...
	expectedSpecRule = v3.Rule{
		Ingress: []v3.IngressRule{
			{
				FromEndpoints: []v3.EndpointSelector{
					v3.NewESFromLabels(
						labels.ParseSelectLabel("role=frontend"),
